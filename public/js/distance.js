  ...
  const svg2 = d3.select("#my_dataviz")
    ...
    .append("g")
      ...
      const myColor = d3.scaleOrdinal()
        ...
        let numm1 = d3.max(dataReady[0]["values"], (d) => d.time);
        let numm2 = d3.max(dataReady[1]["values"], (d) => d.time);
        let numm3 = d3.max(dataReady[2]["values"], (d) => d.time);
        let numm1min = d3.min(dataReady[0]["values"], (d) => d.time);
        let numm2min = d3.min(dataReady[1]["values"], (d) => d.time);
        let numm3min = d3.min(dataReady[2]["values"], (d) => d.time);
